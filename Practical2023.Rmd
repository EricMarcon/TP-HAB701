...
plot(x = zones$longitude, y = zones$longitude, asp = 1)
```
...
species %>% 
  ...
  mutate(species = c(paste(genre, espece, sep = "_"))) %>% 
...
# alternative: rely on species names and SPAD (poor choice)
traits_distance <- gowdis(traits[, 1:2])
